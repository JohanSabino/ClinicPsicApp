<x-psychologist-app-layout>
    <!-- Hero Banner que fluye del navbar -->
    <div class="background-clinic-gradient pt-16 pb-10 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="mb-8">
                ...
                <p class="text-white/70 mt-1">
                    {{ __('Bienvenido de nuevo, ') }} <span class="font-medium text-white">{{ Auth::user()->first_name }}</span>
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white/10 backdrop-blur-sm overflow-hidden rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-medium text-white/70">Pacientes Activos</p>
                                <p class="text-2xl font-bold text-white">156</p>
                                <p class="text-xs text-green-300">+12% este mes</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white/10 backdrop-blur-sm overflow-hidden rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-medium text-white/70">Citas Hoy</p>
                                <p class="text-2xl font-bold text-white">8</p>
                                <p class="text-xs text-blue-200">2 pendientes</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white/10 backdrop-blur-sm overflow-hidden rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-medium text-white/70">Historias Clínicas</p>
                                <p class="text-2xl font-bold text-white">342</p>
                                <p class="text-xs text-white/60">Total registradas</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white/10 backdrop-blur-sm overflow-hidden rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-medium text-white/70">Psicólogos</p>
                                <p class="text-2xl font-bold text-white">12</p>
                                <p class="text-xs text-green-300">10 activos</p>
                            </div>
                        </div>
                    </div>
                </div>
