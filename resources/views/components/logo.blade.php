<a {{ $attributes->merge(['class' => 'toggleColour text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl']) }} href="{{ route('home') }}">
    <svg class="h-10 inline" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#090979">
        <style>
            @keyframes pulsate {
                0%, to {
                    transform: scale(1)
